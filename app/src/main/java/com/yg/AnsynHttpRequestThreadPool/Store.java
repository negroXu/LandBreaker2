...
/*	
	"cardTypeList":[{"id":1,"typeName":"VISA"},{"id":2,"typeName":"MASTERCARD"},{"id":3,"typeName":"JCB"},{"id":4,"typeName":"���ڿ�"},{"id":5,"typeName":"�y��"}],
	"storeNum":"",
...
//					        	Log.i("store", key+ ":" + itemObj.getString(key));
						...
						if(tempItem.equals("cardTypeList") || tempItem.equals("typeSet")){ // ���� cardTypeList typeSet
